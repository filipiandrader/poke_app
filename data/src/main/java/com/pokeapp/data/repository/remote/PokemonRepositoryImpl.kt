...
import com.pokeapp.base_feature.util.extensions.formatNamePokemon
import com.pokeapp.base_feature.util.extensions.getPokemonID
...
class PokemonRepositoryImpl(
        private val api: com.pokeapp.data_remote.service.PokemonService,
        private val pokemonRoom: PokemonRoom
) : com.pokeapp.data.PokemonRepository {
    ...
    override suspend fun getAllTypes(): ResultRequest<com.pokeapp.data_remote.model.TypeResponse> {

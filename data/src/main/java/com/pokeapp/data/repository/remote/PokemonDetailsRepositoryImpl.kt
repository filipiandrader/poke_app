...
import com.pokeapp.base_feature.util.extensions.getPokemonGeneration
...
class PokemonDetailsRepositoryImpl(private val api: com.pokeapp.data_remote.service.PokemonService) : com.pokeapp.data.PokemonDetailsRepository {
